...
def validate_subscription():
    ...
    upstream = 'jesusvasquez333/verify-pr-label-action'
    action = os.environ.get('GITHUB_ACTION_REPOSITORY', '')
    docs_url = 'https://docs.stepsecurity.io/actions/stepsecurity-maintained-actions'

    print('')
    print('\u001b[1;36mStepSecurity Maintained Action\u001b[0m')
    print(f'Secure drop-in replacement for {upstream}')
    if repo_private is False:
        print('\u001b[32m\u2713 Free for public repositories\u001b[0m')
    print(f'\u001b[36mLearn more:\u001b[0m {docs_url}')
    print('')
    ...
    url = (
        f'https://agent.api.stepsecurity.io/v1/github/{github_repo}'
    ...
    try:
        ...
        if e.code == 403:
            ...
            print(
                f'\u001b[31mLearn how to enable a subscription: {docs_url}\u001b[0m',
                file=sys.stderr
            )
            sys.exit(1)
